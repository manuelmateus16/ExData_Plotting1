...
# Subset the date and values of sub-metering to the desired days
...
# Plot the graphic and save it to the file
...
legend("topright",col=c("black","red","blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty=1, text.width = 85000)
